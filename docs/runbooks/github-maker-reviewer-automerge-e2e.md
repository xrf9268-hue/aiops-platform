...
GH_CONFIG_DIR="$AIOPS_GHMR_SETUP_GH_CONFIG_DIR" gh auth setup-git
GH_CONFIG_DIR="$AIOPS_GHMR_MAKER_GH_CONFIG_DIR" gh auth setup-git
GH_CONFIG_DIR="$AIOPS_GHMR_REVIEWER_GH_CONFIG_DIR" gh auth setup-git

GH_CONFIG_DIR="$AIOPS_GHMR_MAKER_GH_CONFIG_DIR" gh api user --jq .login
GH_CONFIG_DIR="$AIOPS_GHMR_REVIEWER_GH_CONFIG_DIR" gh api user --jq .login
```
