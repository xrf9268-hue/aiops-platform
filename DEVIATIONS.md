...
| D13 | Workspace key by `<repo>_<task_id>` instead of sanitized issue identifier                         | §4.2, §9.1, §9.2                                          | High     | Open                    | [#87](https://github.com/xrf9268-hue/aiops-platform/issues/87)                                                                       |
