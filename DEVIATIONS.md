...
| D13 | Workspace key by `<repo>_<task_id>` instead of sanitized issue identifier; reuse + `after_create` realignment | §4.2, §9.1, §9.2, §9.4, §17.2                              | High     | Closed                  | [#87](https://github.com/xrf9268-hue/aiops-platform/issues/87), realignment [#245](https://github.com/xrf9268-hue/aiops-platform/issues/245) |
