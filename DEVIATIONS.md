...
| D17 | `strings.ReplaceAll` template vs Liquid-strict; `attempt` variable never threaded                 | §5.4, §12.2, §17.1                                        | Medium   | Closing via PR          | [#91](https://github.com/xrf9268-hue/aiops-platform/issues/91)                                                                       |
