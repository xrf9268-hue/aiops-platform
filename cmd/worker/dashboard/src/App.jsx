      ...
      <div className="title-row">
        <div>
          ...
          <p className="page-sub">
            ...
            <br />
            <span>Token totals and token guardrails cover worker-observed, runner-reported Codex usage only; external GitHub @codex review, other reviewers outside the worker session, and otherwise unreported nested or subagent usage are excluded, not counted as zero.</span>
          </p>
        </div>
